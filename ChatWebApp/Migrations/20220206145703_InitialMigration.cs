    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUserChats", x => x.Id);
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ApplicationUserChats_Chats_ChatsId",
                        column: x => x.ChatsId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUserChats_ApplicationUserId",
                table: "ApplicationUserChats",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUserChats_ChatsId",
                table: "ApplicationUserChats",
                column: "ChatsId");
